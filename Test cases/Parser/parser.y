...
%token BOOL CHAR INT DOUBLE VOID ID STRING_LITERAL SF_OPEN SF_CLOSE STRUCT
%token TEX TEX_OPEN TEX_CLOSE MS_OPEN MS_CLOSE
...
translation
	: translation SF_OPEN translation_init SF_CLOSE 
	| SF_OPEN translation_init SF_CLOSE
	;

translation_init
	: ID MS_OPEN translation_unit MS_CLOSE translation_unit
	;
